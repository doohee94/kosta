...
<link rel="stylesheet"
	href="/angel/plan/plan_couple/assets/css/main.css" />
...
<noscript>
	<link rel="stylesheet"
		href="/angel/plan/plan_couple/assets/css/noscript.css" />
</noscript>
...
<script
	src='/angel/plan/plan_couple/fullcalendar-3.4.0/fullcalendar-3.4.0/lib/jquery.min.js'></script>
			...
			<div id="main">
				...
				<article id="me" class="panel">
					<header>
							...
							%>
							<form action='<%=projectName%>/pds' method='post'
								enctype='multipart/form-data'>
								
								<tr>파일: <input type="file" name="file" /> </tr>
								<tr><br /> 제목: <input type="text" name="title" /></tr>
								 <tr>설명: <input type="text" name="description" /></tr>
								  <tr><br /> <input type="submit" value="업로드" /></tr>
							</form>
							...
							<div class="modal-content  modal-fullsize">
								...
								<div class="modal-body">
									...
									<form id="container2" name="container2">
										START DAY <input type="text" name="startDay"
											autocomplete="off" id="startDay" placeholder="ex)2017-05-11" />
										...
										START TIME <select name="startTime" id="startTime">
											...
											%>
										</select> <br /> END DAY<input type="text" name="endDay"
											autocomplete="off" id="endDay" placeholder="ex)2017-05-11" />

										END TIME <select name="endTime" id="endTime">
										...
										</select> <br /> <br /> EVENT COLOR <select id='color' name='color'>

											<option value="ffffff"
												style="color: #ffffff; background-color: #000000;">WHITE</option>
											<option value="6495ED" style="color: #6495ED;">CornflowerBlue</option>
											<option value="90EE90" style="color: #90EE90;">LightGreen
											</option>
											<option value="FF0000" style="color: #FF0000;">RED</option>


										</select> <br />
										<br /> CONTENT <input type="text" name="title"
											autocomplete="off" id="content" name="content"
											placeholder="only english" /> <br />
					...
					<div class="modal fade" id="myModal2" role="dialog"
						...
						<div class="modal-dialog  modal-fullsize">
							...
							<div class="modal-content  modal-fullsize">
								...
								<div class="modal-body">Are you really going to change the
									schedule?</div>
								<div class="modal-footer">
									<input type="hidden" id="id" name="id" /> <input type="hidden"
										id="mSday" name="mSday" /> <input type="hidden" id="mEday"
										name="mEday" />
									<button type="button" class="btn btn-default" id="modify"
										name="modify">YES</button>
									<button type="button" class="btn btn-default"
					...
					<div class="modal fade" id="myModal3" role="dialog"
						...
						<div class="modal-dialog  modal-fullsize">
							...
							<div class="modal-content  modal-fullsize">
								...
								<div class="modal-body">Are you really going to DELETE the
									schedule?</div>
								<div class="modal-footer">
									<input type="hidden" id="id" name="id" /> <input type="hidden"
										id="mSday" name="mSday" /> <input type="hidden" id="mEday"
