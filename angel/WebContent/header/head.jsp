...
<title>Angel</title>
<link rel="stylesheet" href="/test/plan/plan_person/assets/css/tab.css"/>
...
$(function(){
	 ...
	 $("#naviImg").hover(function(){
   	  ...
   	  $('#naviImg').attr("src","/test/plan/plan_person/assets/css/images/over.png");
     }, function(){
   	  $('#naviImg').attr("src","/test/plan/plan_person/assets/css/images/out.png");
...
<body>
 ...
 <div class="jbTitle">
   		<img src="/test/plan/plan_person/assets/css/images/logosamlple.png" id="logo" name="logo"></img>
    </div>
    
    <div class="jbMenu">
      <p>
     <img src="/test/plan/plan_person/assets/css/images/out.png" onclick="openNav()" id='naviImg' name="naviImg"></img>
      </p>
...
<div id="mySidenav" class="sidenav">
	<div class="jbTitle"  >
   		<img src="/test/plan/plan_person/assets/css/images/logosamlple.png" id="logo_in_nave" name="logo_in_nave"  ></img>
    </div>
    <br/>
  ...
  <ul class="acc-menu" id="accordionMenu1">  
	...
	<br/><br/><br/><br/><br/>
			...
			<img src="/test/plan/plan_person/assets/css/images/logout.png"></img>
			</footer>
