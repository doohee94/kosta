...
<html>
	<head>
		...
		<link rel="stylesheet" href="/test/plan/plan_couple/assets/css/main.css" />
		
		<!-- 풀캘린더 -->
		<link rel='stylesheet' href='/test/plan/plan_couple/fullcalendar-3.4.0/fullcalendar-3.4.0/fullcalendar.css' />
		<!-- Latest compiled and minified CSS -->
		<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">
		<!-- Optional theme -->
		<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap-theme.min.css" integrity="sha384-rHyoN1iRsVXV4nD0JutlnGaslCJuC7uwjduW9SVrLvRYooPp2bWYgmgJQIXwl/Sp" crossorigin="anonymous">
		
		<noscript><link rel="stylesheet" href="/test/plan/plan_couple/assets/css/noscript.css" /></noscript>
...
#mymodal2.modal-fullsize{
 ...
 text-align: center;
		...
		<script src='/test/plan/plan_couple/fullcalendar-3.4.0/fullcalendar-3.4.0/lib/jquery.min.js'></script>
		<script src='/test/plan/plan_couple/fullcalendar-3.4.0/fullcalendar-3.4.0/lib/moment.min.js'></script>
		<script src='/test/plan/plan_couple/fullcalendar-3.4.0/fullcalendar-3.4.0//fullcalendar.js'></script>
		<script src="/test/plan/plan_couple/fullcalendar-3.4.0/fullcalendar-3.4.0/locale-all.js"></script>
    ...
    $('#calendar').fullCalendar({
       ...
       header: {
        ...
        events: {
        	...
        	url : 'plan?cmd=list-page&ajax=true&id='+id+'&cid='+cid,
           dataType : 'json'
       ...
       ,eventClick:function(event){
    	  ...
    	  $("#submit").click(function(){
    		 ...
    		 var color = $('#color option:selected').val();
    			...
    			var url =  "plan?cmd=insert-couple-page&title="+title+"&startDay="+FullSDay+"&endDay="+FullEDay+"&color="+color+"&cid="+cid+"&id="+id;
    	...
    	var eDay =   $('#mEday').val();
   		...
   		var url =  "plan?cmd=modify-couple-page&id="+id+"&sDay="+sDay+"&eDay="+eDay;
		$(location).attr('href',url);
    	  ...
    	  $("#delete").click(function(){
    	    	var id = $('#id').val();
    	   		var url =  "plan?cmd=delete-couple-page&id="+id;
    			$(location).attr('href',url);
...
<div id="sidemain" class="jbContent">  <!-- @@@@@여기 해줘야 바뀜 -->
	...
	<!-- Footer -->
		...
		<!-- Scripts -->
			<script src="/test/plan/plan_couple/assets/js/jquery.min.js"></script>
			<script src="/test/plan/plan_couple/assets/js/skel.min.js"></script>
			<script src="/test/plan/plan_couple/assets/js/skel-viewport.min.js"></script>
			<script src="/test/plan/plan_couple/assets/js/util.js"></script>
			<!--[if lte IE 8]><script src="assets/js/ie/respond.min.js"></script><![endif]-->
			<script src="/test/plan/plan_couple/assets/js/main.js"></script>
