...
<html>
	<head>
		...
		<!-- 풀캘린더 -->
		<link rel='stylesheet' href='/angel/plan/plan_couple/fullcalendar-3.4.0/fullcalendar-3.4.0/fullcalendar.css' />
...
#mymodal2.modal-fullsize{
 ...
 text-align: center;
		...
		<script src='/angel/plan/plan_couple/fullcalendar-3.4.0/fullcalendar-3.4.0/lib/moment.min.js'></script>
		<script src='/angel/plan/plan_couple/fullcalendar-3.4.0/fullcalendar-3.4.0//fullcalendar.js'></script>
		<script src="/angel/plan/plan_couple/fullcalendar-3.4.0/fullcalendar-3.4.0/locale-all.js"></script>
