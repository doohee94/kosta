...
<title>Angel</title>
<link rel="stylesheet" href="/angel/header/css/tab.css"/>
...
<script type="text/javascript" src="/angel/header/js/tab.js"></script>
...
$(function(){
	 ...
	 $("#naviImg").hover(function(){
   	  ...
   	  $('#naviImg').attr("src","/angel/header/img/over.png");
     }, function(){
   	  $('#naviImg').attr("src","/angel/header/img/out.png");
...
<body>
 ...
 <div class="jbTitle">
   		<img src="/angel/header/img/logosamlple.png" id="logo" name="logo"></img>
    </div>
    
    <div class="jbMenu">
      <p>
     <img src="/angel/header/img/out.png" onclick="openNav()" id='naviImg' name="naviImg"></img>
      </p>
...
<div id="mySidenav" class="sidenav">
	<div class="jbTitle"  >
   		<img src="/angel/header/img/logosamlple.png" id="logo_in_nave" name="logo_in_nave"  ></img>
    </div>
    <br/>
  ...
  <ul class="acc-menu" id="accordionMenu1">  
	...
	<br/><br/><br/><br/><br/>
			...
			<img src="/angel/header/img/logout.png"></img>
			</footer>
